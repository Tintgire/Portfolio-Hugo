...
const experiences = [
  ...
  {
    type: 'Bootcamps intensifs',
    title: 'École 42 (La Piscine) & The Hacking Project',
    company_name: '42 + THP',
    context: 'Premier pivot vers le développement — deux formats 7J/7',
    icon: ecole,
    iconBg: '#231851',
    date: '2019',
    challenge: `Tester l'aptitude au métier de développeur via deux bootcamps réputés, en intensif.`,
    points: [
      `42 La Piscine — programmation C, résolution de problèmes, peer learning, autonomie totale.`,
      `The Hacking Project — Ruby, Ruby on Rails, projets full-stack en équipe.`,
      `Confirmation de la voie : pivot complet vers le développement à la suite.`,
    ],
    stack: ['C', 'Ruby', 'Ruby on Rails'],
  },
]
